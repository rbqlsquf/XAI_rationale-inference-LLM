...
if __name__ == "__main__":
    ...
    instruction = (
        instruction
    ) = """Read the provided **Related Document**, find the **Answer** to the given **Question**, and extract it from the **Related Document**. Additionally, extract the sentence numbers that is crucial for inferring the **Answer** from the **Related Document** and write it in the **Supporting Sentences**. You must strictly follow the **Output format** and provide valid information for all items. There is nothing that cannot be filled
...
"""
    ...
    #### 답변작성
    output_path = "phi3-5_asnwer.json"
