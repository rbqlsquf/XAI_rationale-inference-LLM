...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_model_path", type=str, default="model/1111_1107_yesloss_concat/checkpoint-1000")
    ...
    parser.add_argument("--output_dir", type=str, default="result/1111_1107_yesloss_concat/hotpot_1000.json")
