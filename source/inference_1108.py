...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_model_path", type=str, default="model/1110_1106_concat/checkpoint-4200")
    ...
    parser.add_argument("--output_dir", type=str, default="result/1110_1106_concat/hotpot_4200.json")
