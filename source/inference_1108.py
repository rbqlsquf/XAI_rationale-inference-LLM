...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_model_path", type=str, default="model/1115_yesloss_final/checkpoint-1800")
    ...
    parser.add_argument("--output_dir", type=str, default="result/1115_yesloss_final/1800.json")
