...
from modeling_qwen2_pn import Qwen2ForCausalLM_pn, BeamSearchAttentionDecoder
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_model_path", type=str, default="model/1105_noloss/checkpoint-1000")
    ...
    parser.add_argument("--output_dir", type=str, default="result/1105_noloss/hotpot_tt_1000.json")
