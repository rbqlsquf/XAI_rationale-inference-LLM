...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_model_path", type=str, default="/hdd/rbqlsquf/1124_upper/checkpoint-11000")
    ...
    parser.add_argument("--output_dir", type=str, default="result/1124_upper/11000.json")
